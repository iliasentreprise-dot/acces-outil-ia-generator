      ...
      <table width="600" cellpadding="0" cellspacing="0" style="background:#0D0D10;border:1px solid rgba(201,168,76,0.2);border-radius:8px;padding:48px;">
        ...
        <tr><td style="padding-bottom:28px;">
          <div style="background:rgba(201,168,76,0.06);border:1px solid rgba(201,168,76,0.2);border-radius:4px;padding:24px 28px;">
            ...
            <p style="font-size:15px;line-height:1.9;color:#F5F0E8;margin:0;">
              Félicitations — tu viens d'avoir accès à l'un des outils <strong style="color:#C9A84C;">les plus puissants du marché francophone.</strong>
            </p>
          </div>
        </td></tr>
        <tr><td style="font-size:14px;line-height:1.9;color:#B0A898;padding-bottom:24px;">
          Cet outil est normalement <strong style="color:#F5F0E8;">réservé aux membres de la formation DropDigital</strong>.<br>
          Tu peux la découvrir ici :
        </td></tr>
        <tr><td style="padding-bottom:32px;">
          <a href="https://systemedigitalpirate.lovable.app" style="display:inline-block;border:1px solid rgba(201,168,76,0.4);color:#C9A84C;padding:10px 24px;font-size:11px;letter-spacing:2px;text-decoration:none;border-radius:2px;">
            🏴‍☠️ VOIR LA FORMATION DROPDIGITAL
          </a>
        </td></tr>
        ...
        <tr><td align="center" style="padding-bottom:8px;">
          <a href="https://outil-carousel-generator.lovable.app" style="display:inline-block;background:#C9A84C;color:#060608;padding:18px 40px;font-weight:700;font-size:13px;text-decoration:none;letter-spacing:2px;border-radius:2px;">
            ⚡ ACCÉDER À L'OUTIL GRATUITEMENT
          </a>
        </td></tr>
        <tr><td align="center" style="padding-bottom:32px;">
          <p style="font-size:11px;color:#8B6914;letter-spacing:1px;margin:8px 0 0;">
